...
class ClinicalNlpToolkit:
    ...
    def process(self, **kw):
        ...
        self._log.append({"op": "process", "ms": round((__import__("time").time()-s)*1000,2), "t": __import__("time").time()})
        return r
    def analyze(self, **kw):
        ...
        self._log.append({"op": "analyze", "ms": round((__import__("time").time()-s)*1000,2), "t": __import__("time").time()})
        return r
    def transform(self, **kw):
        ...
        self._log.append({"op": "transform", "ms": round((__import__("time").time()-s)*1000,2), "t": __import__("time").time()})
        return r
    def validate(self, **kw):
        ...
        self._log.append({"op": "validate", "ms": round((__import__("time").time()-s)*1000,2), "t": __import__("time").time()})
        return r
    def export(self, **kw):
        ...
        self._log.append({"op": "export", "ms": round((__import__("time").time()-s)*1000,2), "t": __import__("time").time()})
        return r
    def get_stats(self):
